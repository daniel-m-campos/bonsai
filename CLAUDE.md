...
- Never hand-edit generated files. They are produced by `make docs-check` renderers and the build: `docs/invariants.md`, `docs/api/parameters.md`, `docs/learn/timeline.md`, `docs/results/results/*`, the README standings block, and `python/bonsai/_params.py`. Edit the source or the generator, then re-render.
...
- Reader-facing docs: `docs/guide/` and `docs/learn/` teach; `docs/api/` and `docs/results/` are reference, generated where possible.
