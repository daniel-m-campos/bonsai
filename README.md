...
| **Best mean rank on the 55-task Grinsztajn tabular benchmark under either min_child_weight convention** (1.73 vs lightgbm 2.35, xgboost 2.73, catboost 3.20 at campaign-mapped knobs; 27 outright wins; second-or-better on 44/55, last once) | [grinsztajn-2026-07](benchmarks/grinsztajn-2026-07.md), decision 68; [`scripts/run_tabular_suite.py`](scripts/run_tabular_suite.py) |
| **Best library on 9 of 10 datasets of the internal quality campaign** | [quality-campaign](benchmarks/quality-campaign-2026-07.md), decisions 56–57 |
