...
| **Best mean rank on the 55-task Grinsztajn tabular benchmark** (2.04 vs xgboost 2.11, lightgbm 2.53, catboost 3.33 at matched knobs; second-or-better on 44/55, last once) | [grinsztajn-2026-07](benchmarks/grinsztajn-2026-07.md), decision 68; [`scripts/run_tabular_suite.py`](scripts/run_tabular_suite.py) |
