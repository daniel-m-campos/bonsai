...
The 131k x 16384 rows of the same ladder, where the routing collapsed a 7x deficit to parity, are in [the archive](../../results/results/archive.md). That parity is a 2026-07 reading; the epilogue closes with where wide CPU stands now.
