...
| 22 | [`22-cpu-sweep-fill.md`](22-cpu-sweep-fill.md): deep-level sweep fill: sequential level walk vs per-node lists on the CPU plane | refuted by measurement (issue #355) |
