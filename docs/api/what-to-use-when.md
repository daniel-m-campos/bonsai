...
|---|---|---|
| 1M+ rows, GPU training | bonsai | [perf ledger](../results/results.md#perf-division), [airline AUC](../../benchmarks/airline-2026-07.md) |
| small tabular, heavy categoricals | CatBoost | [cat probe](../../benchmarks/tabarena-cat-probe-2026-07.md) |
| small pure-numeric tabular | depends on the protocol | [Grinsztajn](../results/results/quality-grinsztajn.md#external-standings-the-grinsztajn-suite), [cat probe control](../../benchmarks/tabarena-cat-probe-2026-07.md) |
| memory-constrained hosts | bonsai | [perf ledger](../results/results.md#perf-division) |
| wide or extreme-aspect data (thousands of features) | bonsai | [the archive](../results/results/archive.md), decisions 90 and 91 |
...
Numbers stay in one place: [the results ledger](../results/results.md) and the [scenario panels](../results/results/perf.md) carry every figure, under the rules in [the benchmark protocol](../results/benchmark-protocol.md). This page never restates a digit, so the ledger cannot go stale behind it.
