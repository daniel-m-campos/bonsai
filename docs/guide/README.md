...
| 9 | [Parallelism & determinism](9-parallelism-and-determinism.md) | Same model at any thread count, and why that's rare |
...
Chapters 1–4 are the core algorithm and build on each other. 5–9 are
independent; read them as the corresponding knob becomes relevant.
