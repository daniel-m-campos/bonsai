...
The protocol above is the whole of it. The survey script and its raw rows are closed evidence and live in git history; [the archive](../results/results/archive.md) names the commit that still reads them.
