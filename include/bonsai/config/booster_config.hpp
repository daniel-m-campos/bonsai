...
struct BoosterConfig
{
    ...
    // Evaluate the valid set every k-th round (plus the final round); >= 1.
    // Early stopping keeps its meaning in rounds, checked at those points.
    uint32_t eval_interval = 1;
