...
// Serialize a booster (the dispatch triple, init score, learning rate,
// bin mappers, and every tree) to a MessagePack binary file at `path`.
// The booster must be one of the concrete Booster<O,G,Sa> instantiations
// registered in the dispatch table; otherwise std::runtime_error is thrown.
